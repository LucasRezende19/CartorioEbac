#include <stdio.h> //bibioteca de comunicação com usuário
#include <stdlib.h> //biblioteca de alocação de espaço em memoria
#include <locale.h> //biblioteva de alocaçoes de texto por região
...
int registro() //Função responsável por cadastrar os usuários no sistema
{
	...
	fprintf(file,cpf); // salvo o valor da valor da varieavel
